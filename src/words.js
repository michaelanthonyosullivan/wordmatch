export const WORD_BANK = [
  'ant', 'bag', 'bat', 'bed', 'bee', 'box', 'bug', 'bun',
  'bus', 'can', 'cap', 'car', 'cat', 'cow', 'cub', 'cup',
  'dad', 'day', 'den', 'dog', 'ear', 'egg', 'fan', 'fig',
  'fox', 'fun', 'hat', 'hen', 'hop', 'hug', 'jam', 'jet',
  'kid', 'kit', 'leg', 'lid', 'log', 'map', 'mat', 'mud',
  'net', 'owl', 'pan', 'pen', 'pet', 'pig', 'pot', 'rat',
  'red', 'run', 'sad', 'sit', 'sun', 'tap', 'ten', 'top',
  'toy', 'van', 'web', 'wet', 'win', 'yes', 'zoo',
]
